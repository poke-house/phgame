...
export const CHANGELOG = [
    { version: "5.03", date: "Atual", changes: ["Receita Cozy Chicken atualizada: Base agora é Coconut Basmati + Espinafres (2x)."] },
...
export const INGREDIENTS_DB: IngredientDB = {
    ...
    crispies: ["Ervilhas Wasabi", "Algas Nori", "Amêndoa", "Batata Doce", "Lima", "Bacon", "Croutons", "Batata Doce Crocante", "Não leva", "Cebola Crocante"],
    sesame: ["Sim", "Não"],
